...
public class Task6 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        btnAgregar.setOnAction(e -> mostrarVentanaAgregar(null));
        btnModificar.setOnAction(e -> {
            Persona personaSeleccionada = tableView.getSelectionModel().getSelectedItem();
            if (personaSeleccionada != null) {
                mostrarVentanaAgregar(personaSeleccionada);
            }
        });
        ...
        VBox root = new VBox(10, btnAgregar, btnModificar, btnEliminar, tableView);
    ...
    private void mostrarVentanaAgregar(Persona persona) {
        Stage ventana = new Stage();
        ventana.initModality(Modality.APPLICATION_MODAL);
        ventana.setTitle(persona == null ? "Agregar Persona" : "Modificar Persona");
